...
var movie_1 = require("../src/models/movie");
var tvshow_1 = require("../src/models/tvshow");
...
mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017')
    ...
    Promise.all([
        user_1.default.insertMany(sampleUsers),
        movie_1.default.insertMany(sampleMovies),
        tvshow_1.default.insertMany(sampleTVShows),
    ])
        .then(function () {
