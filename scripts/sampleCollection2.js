...
mongoose_1.default.connect(process.env.MONGO_URI || 'mongodb://localhost:27017')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                users = _a.sent();
                sampleWishlists = users.map(function (user) { return ({
                ...
                return [4 /*yield*/, wishlist_1.default.insertMany(sampleWishlists)];
            case 3:
                // Insert sample wishlists into Wishlist collection
                _a.sent();
            ...
            case 4:
                error_1 = _a.sent();
                console.error('Error inserting sample wishlists:', error_1);
                return [3 /*break*/, 5];
